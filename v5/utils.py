...
def ciou(box1, box2, IoU_mode=False, WidthHeight_model=False): 
	if not WidthHeight_model: 
		b1_x1, b1_y1, b1_x2, b1_y2 = box1[..., 0:1] - box1[..., 2:3] / 2, box1[..., 1:2] - box1[..., 3:4] / 2, box1[..., 0:1] + box1[..., 2:3] / 2, box1[..., 1:2] + box1[..., 3:4] / 2
		b2_x1, b2_y1, b2_x2, b2_y2 = box2[..., 0:1] - box2[..., 2:3] / 2, box2[..., 1:2] - box2[..., 3:4] / 2, box2[..., 0:1] + box2[..., 2:3] / 2, box2[..., 1:2] + box2[..., 3:4] / 2
